...
const Post = ({ post }: { post: blogType }) => {
  ...
  return (
    <Link
      ...
      className="group flex flex-col bg-white rounded-xl overflow-hidden border border-neutral-200 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
    >
      ...
      <div className="flex flex-col gap-4 p-6 flex-1">
        ...
        <h3 className="text-xl lg:text-2xl font-bold text-[#111] line-clamp-2 group-hover:text-primary transition-colors duration-200">
          {post.title}
        </h3>

        <p className="text-neutral-600 leading-relaxed line-clamp-3 text-sm lg:text-base">
          {post.overview}
        </p>
